...
; #define VsVersion = "2017" 
  ...
  #define webviewer = "Webviewer.zip"
  #define mod_spatialite "c:\GITHUB\klimaatatlas\dependencies\mod_spatialite-5.1.0-win-amd64\*.*"
#else
  #define CPU "Win32"
  ...
  #define mod_spatialite "c:\GITHUB\klimaatatlas\dependencies\mod_spatialite-5.1.0-win-x86\*.*"
#endif
...
AppId={{c368d713-cc5f-40ed-9f53-f84fe197b96a}
AppName={#MyAppName}
...
OutputBaseFilename=KlimaatatlasSetup-v{#MyAppVersion}-{#CPU}
...
VersionInfoDescription=Klimaatatlas [www.sobek.tools]
...
Source: "{#mod_spatialite}"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs; 

;write the zip file containing our webviewer
#define viewerdir = "viewer"
;Source: "{#SetupLocation}\{#webviewer}"; DestDir: "{app}\{#viewerdir}"

[Messages]
BeveledLabel=HydroToolbox by Hydroconsult

[Icons]
;; In start menu:
Name: "{commonstartmenu}\{#MyAppPublisher}\{#MyAppName}"; Filename: "{app}\Klimaatatlas.exe"; WorkingDir: "{app}"; Comment: "Start Klimaatatlas"
;; On desktop:
Name: "{commondesktop}\{#MyAppName}"; Filename: "{app}\Klimaatatlas.exe"; WorkingDir: "{app}"; Comment: "Start Klimaatatlas"
...
Filename: "{app}\Klimaatatlas.exe"; Flags: shellexec runasoriginaluser postinstall nowait skipifsilent; Description: "Start Klimaatatlas?"
