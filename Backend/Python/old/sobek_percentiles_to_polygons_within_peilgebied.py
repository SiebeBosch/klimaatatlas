...
# Inputs
polygon_shapefile_path = r"c:\GITHUB\klimaatatlas\GIS\Watervlakken Plus4.shp"
...
print(f"retrieving unique combinations of scenario and substance from WQPOINTRESULTS")
cur.execute("""
