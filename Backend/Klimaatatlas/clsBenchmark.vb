...
Public Class clsBenchmark
    ...
    Public Sub New(ByRef myKlimaatatlas As clsKlimaatatlas, myName As String, myFieldName As String, myClassificationType As clsKlimaatatlas.enmClassificationType)
